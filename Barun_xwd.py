...
os.system("alias BARUNv3='cd BARUNv3 && python run.py'")
###----------[ WARNA PRINT RICH ]---------- ###
M2 = "[#FF0000]" # MERAH
H2 = "[#00FF00]" # HIJAU
K2 = "[#FFFF00]" # KUNING
...
def contact():
	os.system('xdg-open https://www.facebook.com/profile.php?id=100078611350986')
	back()
def animation(u):
...
def approval():
  ...
  print ("""\033[1;37m----------------------------------------------""")
  try:
    httpCaht = requests.get("https://github.com/B4RUN/approval/blob/main/approval.txt").text
    if id in httpCaht:
...
def passu():
	...
	linex()
	prints(f' >> Dont see here your father is fucking your mother')
	linex()
	prog = Progress(TextColumn(' [BARUN-DS]{task.description}'))
	...
	with prog:
		...
		linex()
	linex()
	print(' [\u001b[36m•\033[1;37m] CLONING SAKIYO RANDI KO BAN')
